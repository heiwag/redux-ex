...
let store = _redux.createStore(countReducer, window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__());
...
document.querySelector('#btn').addEventListener('click', function() {
    if (window.__REDUX_DEVTOOLS_EXTENSION__) window.__REDUX_DEVTOOLS_EXTENSION__.send('custom/btnClick', {
        time: Date.now()
    });
});
...
},{}]},["lBB98","hD4hw"], "hD4hw", "parcelRequire9d9b")
